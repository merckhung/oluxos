...
#define KDBGER_INFO_MEMORY_BASE \
  KDBGER_INFO_BAR_FMT KDBGER_INFO_MEMORY_FUNC "    Address: "
#define KDBGER_INFO_IO_BASE \
  KDBGER_INFO_BAR_FMT KDBGER_INFO_IO_FUNC "    Address: "
#define KDBGER_INFO_PCI_BASE KDBGER_INFO_BAR_FMT KDBGER_INFO_PCI_FUNC "    "
#define KDBGER_INFO_IDE_BASE \
  KDBGER_INFO_BAR_FMT KDBGER_INFO_IDE_FUNC "    Address: "
#define KDBGER_INFO_CMOS_BASE \
  KDBGER_INFO_BAR_FMT KDBGER_INFO_CMOS_FUNC "    Address: "
...
#define KDBGER_WELCOME_TXT                                                     \
  "Welcome to OluxOS Kernel Debugger. Copyright (C) 2006 - 2011, Merck Hung "  \
  "all right reserved. Contact Merck Hung, Email: merckhung@gmail.com, Cell: " \
  "+886-988-682504, City: Taipei City, Taiwan."

#define KDBGER_DUMP_TOP_BAR "00 01 02 03 04 05 06 07 08 09 0A 0B 0C 0D 0E 0F"
#define KDBGER_DUMP_LEFT_BAR \
  "000000100020003000400050006000700080009000A000B000C000D000E000F0"
...
#define KDBGER_DUMP_RTOP_COLUMN \
  (KDBGER_DUMP_TOP_COLUMN + strlen(KDBGER_DUMP_TOP_BAR) + 2)
...
#define KDBGER_DUMP_VBUF_SZ \
  (KDBGER_BYTE_PER_SCREEN * 3 - KDBGER_DUMP_BYTE_PER_LINE)
...
#define KDBGER_PCIL_TITLE                                                     \
  "PCI/PCI-E Device Listing                                   Ven  Dev  Bus " \
  "Dev Fun"
#define KDBGER_PCIL_LINE_FMT \
  "%-12.12s,%-45.45s %4.4X %4.4X  %2.2X  %2.2X  %2.2X"
...
#define printWindow(RESRC, NAME, LINE, COLUMN, X, Y, COLORPAIR, FORMAT, \
                    ARGS...)                                            \
  {                                                                     \
...
#define printWindowAt(RESRC, NAME, LINE, COLUMN, X, Y, COLORPAIR, FORMAT, \
                      ARGS...)                                            \
  {                                                                       \
    if (!RESRC.NAME) {                                                    \
      RESRC.NAME = newwin(LINE, COLUMN, X, Y);                            \
...
#define printWindowMove(RESRC, NAME, LINE, COLUMN, X, Y, COLORPAIR, FORMAT, \
                        ARGS...)                                            \
  {                                                                         \
    if (RESRC.panel##NAME) {                                                \
