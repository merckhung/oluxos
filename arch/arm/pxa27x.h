...
#define PXA27X_BTUART_RBR       (PXA27X_BTUART_BASE + 0x00)
#define PXA27X_BTUART_THR       (PXA27X_BTUART_BASE + 0x00)
#define PXA27X_BTUART_IER       (PXA27X_BTUART_BASE + 0x04)
#define PXA27X_BTUART_IIR       (PXA27X_BTUART_BASE + 0x08)
#define PXA27X_BTUART_FCR       (PXA27X_BTUART_BASE + 0x08)
#define PXA27X_BTUART_LCR       (PXA27X_BTUART_BASE + 0x0C)
#define PXA27X_BTUART_MCR       (PXA27X_BTUART_BASE + 0x10)
#define PXA27X_BTUART_LSR       (PXA27X_BTUART_BASE + 0x14)
#define PXA27X_BTUART_MSR       (PXA27X_BTUART_BASE + 0x18)
#define PXA27X_BTUART_SPR       (PXA27X_BTUART_BASE + 0x1C)
#define PXA27X_BTUART_ISR       (PXA27X_BTUART_BASE + 0x20)
#define PXA27X_BTUART_DLL       (PXA27X_BTUART_BASE + 0x00)
#define PXA27X_BTUART_DLH       (PXA27X_BTUART_BASE + 0x04)


#define PXA27X_STUART_BASE      0x40700000
#define PXA27X_STUART_RBR       (PXA27X_STUART_BASE + 0x00)
#define PXA27X_STUART_THR       (PXA27X_STUART_BASE + 0x00)
#define PXA27X_STUART_IER       (PXA27X_STUART_BASE + 0x04)
#define PXA27X_STUART_IIR       (PXA27X_STUART_BASE + 0x08)
#define PXA27X_STUART_FCR       (PXA27X_STUART_BASE + 0x08)
#define PXA27X_STUART_LCR       (PXA27X_STUART_BASE + 0x0C)
#define PXA27X_STUART_MCR       (PXA27X_STUART_BASE + 0x10)
#define PXA27X_STUART_LSR       (PXA27X_STUART_BASE + 0x14)
#define PXA27X_STUART_MSR       (PXA27X_STUART_BASE + 0x18)
#define PXA27X_STUART_SPR       (PXA27X_STUART_BASE + 0x1C)
#define PXA27X_STUART_ISR       (PXA27X_STUART_BASE + 0x20)
#define PXA27X_STUART_DLL       (PXA27X_STUART_BASE + 0x00)
#define PXA27X_STUART_DLH       (PXA27X_STUART_BASE + 0x04)
