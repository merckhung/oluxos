...
#define P_SUP_WT_RW_4K                                                         \
  (P_PRESENT | P_RDWR | P_SUPERVISOR | P_WTHROUGH | P_CACHE_DIS | P_NOACCESS | \
   P_NODIRTY | P_PSIZE_4KB | P_GLO_NORMAL)

#define P_SUP_WT_RW_4M                                                         \
  (P_PRESENT | P_RDWR | P_SUPERVISOR | P_WTHROUGH | P_CACHE_DIS | P_NOACCESS | \
   P_NODIRTY | P_PSIZE_4MB | P_GLO_NORMAL)
